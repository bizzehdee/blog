...
* Worker A is tasked with Job A to be performed weekly
* Worker B is tasked with Job B to be performed daily
* One day, Worker B is away, and Job B needs to be performed
* Worker A is asked to perform Job B by Manager C
* Worker A has no previous knowledge of Job B, but is competent, so performs Job B
...
* Worker B for not properly documenting the processes of Job B?
* Worker A for not properly following the existing documentation of Job B?
* Worker A for not properly performing Job B?
* Manager C for practices that mean only Worker B is qualified to perform Job B?
* Manager C for asking Worker A who has no knowledge of Job B to perform Job B?
